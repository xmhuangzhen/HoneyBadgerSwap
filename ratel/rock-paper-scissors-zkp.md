...
```
```shell
bash ratel/src/compile.sh rockPaperScissors_zkp
```
...
```
```shell
bash ratel/src/run.sh rockPaperScissors_zkp 0,1,2,3 4 1 1 0
```
...
```shell
python3 -m ratel.src.python.rockPaperScissors_zkp.integration_test 
```
